...
[![](datepicker.gif)](https://github.com/weblineindia/Vue-Datepicker/datepicker.gif)

************************************************************************************
[![](darktheme.gif)](https://github.com/weblineindia/Vue-Datepicker/darktheme.gif)
...
We also provide a free, basic support for all users who want to use this VueJS Datepicker in their software project. In case you want to customize this Datepicker to suit your software development needs, then feel free to contact our [VueJS developers](https://www.weblineindia.com/hire-vuejs-developer.html).
...
vue-weblineindia-datepicker is inspired by [primevue](https://primefaces.org/primevue/showcase/#/calendar).

## License

[MIT](LICENSE)

[mit]: hhttps://github.com/weblineindia/Vue-Datepicker/blob/master/LICENSE

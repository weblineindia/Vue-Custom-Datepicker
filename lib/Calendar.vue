  ...
  <span :class="containerClass">
    <div class="inputbox">
      ...
      <CalendarButton
        ...
        :icon="icon"
        tabindex="-1"
        class="p-datepicker-trigger p-calendar-button"
...
export default {
  ...
  methods: {
    ...
    incrementHour(event) {
      ...
      const newHour = this.currentHour;
    ...
    incrementMinute(event) {
      const newMinute = this.currentMinute;
    ...
    decrementMinute(event) {
      let newMinute = this.currentMinute;
    ...
    incrementSecond(event) {
      const newSecond = this.currentSecond;
    ...
    decrementSecond(event) {
      let newSecond = this.currentSecond;
